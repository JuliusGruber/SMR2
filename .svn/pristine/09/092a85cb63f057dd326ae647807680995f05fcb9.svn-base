...
require([ 
	...
	function radioClicked() {
		...
		case "artist":
			...
			$('#tags1').hide();
			$('#playlistSelectLabel').hide();
			$("#artistSimilarityInfoCell").append( $("#similarityInfo") );
			$('#simBasedOn1').append( $("#similarityBasedOnLabel") );
		...
		case "song":
			...
			$("#songSimliarityInfoCell" ).append( $("#similarityInfo") );
			$('#simBasedOn2').append( $("#similarityBasedOnLabel") );
		...
		case "genre":
			...
			$("#genreSimilarityInfoCell").append( $("#similarityInfo") );
			$('#simBasedOn3').append( $("#similarityBasedOnLabel") );
		...
		case "spotifyPlaylist":
			...
			$("#playlistSimilarityInfoCell").append( $("#similarityInfo") );
			$('#simBasedOn4').append( $("#similarityBasedOnLabel") );
