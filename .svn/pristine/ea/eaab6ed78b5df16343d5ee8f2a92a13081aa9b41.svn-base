...
function disableGUI(){
	 ...
	 $("#nextSongsArrow").button('option','disabled', true);
}
...
function enableGUI(){
	...
	$("#nextSongsArrow").button('option','disabled', false);
...
//	 resetSliders();
	...
	if (track == null) {
		...
		artistName = models.player.track.artists[0].name;
		//console.log('ECHONEST DYNAMIC  changeSeedSongSimilarity1() artistname: '+artistName);
